"""Claude Code API provider for auto-pr.
...
from auto_pr.providers.base import AnthropicCompatibleProvider, ProviderConfig
...
class ClaudeCodeProvider(AnthropicCompatibleProvider):
    ...
    def _get_api_key(self) -> str:
        ...
        raise AIError.authentication_error(
            "Claude Code authentication not found. Run 'auto-pr auth claude-code login' to authenticate."
        )
