"""Qwen API provider for auto-pr with OAuth-only support."""
...
class QwenProvider(OpenAICompatibleProvider):
    ...
    def _get_oauth_token(self) -> tuple[str, str]:
        ...
        raise AIError.authentication_error("Qwen OAuth token not found. Run 'auto-pr auth qwen login' to authenticate.")
