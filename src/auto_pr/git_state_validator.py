#!/usr/bin/env python3
"""Git state validation and management for auto-pr."""
...
from auto_pr.config import AutoPRConfig
from auto_pr.errors import ConfigError, GitError, handle_error
from auto_pr.git import get_staged_files, get_staged_status, run_git_command
from auto_pr.preprocess import preprocess_diff
from auto_pr.security import get_affected_files, scan_staged_diff
...
class GitStateValidator:
    ...
    def get_git_state(
        ...
        if model is None:
            raise ConfigError("Model must be specified via AUTO_PR_MODEL environment variable or --model flag")
