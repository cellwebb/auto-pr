...
def create_provider_test_cases() -> list[ProviderTestCase]:
    ...
    from auto_pr.providers.anthropic import call_anthropic_api
    from auto_pr.providers.cerebras import call_cerebras_api
    from auto_pr.providers.gemini import call_gemini_api
    from auto_pr.providers.groq import call_groq_api
    from auto_pr.providers.lmstudio import call_lmstudio_api
    from auto_pr.providers.ollama import call_ollama_api
    from auto_pr.providers.openai import call_openai_api
    from auto_pr.providers.openrouter import call_openrouter_api
    from auto_pr.providers.replicate import call_replicate_api
    from auto_pr.providers.streamlake import call_streamlake_api
    from auto_pr.providers.zai import call_zai_api, call_zai_coding_api
