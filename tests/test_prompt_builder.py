...
from auto_pr.prompt_builder import PromptBuilder, PromptBundle
...
class TestPromptBuilder:
    ...
    @patch("auto_pr.prompt.build_prompt")
    ...
    @patch("auto_pr.prompt.build_group_prompt")
    ...
    @patch("auto_pr.prompt_builder.Panel")
    @patch("auto_pr.prompt_builder.Console")
    ...
    def test_build_prompts_with_language_override(self, builder, mock_git_state):
        ...
        with patch("auto_pr.prompt.build_prompt") as mock_build_prompt:
            mock_build_prompt.return_value = ("system", "user")
