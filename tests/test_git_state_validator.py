...
from auto_pr.git_state_validator import GitStateValidator
...
class TestGitStateValidator:
    ...
    @patch("auto_pr.git_state_validator.run_git_command")
    ...
    @patch("auto_pr.git_state_validator.run_git_command")
    @patch("auto_pr.git_state_validator.handle_error")
    ...
    @patch("auto_pr.git_state_validator.get_staged_files")
    ...
    @patch("auto_pr.git_state_validator.scan_staged_diff")
    def test_get_git_state_with_secrets(self, mock_scan, validator):
        ...
        with (
            ...
            patch("auto_pr.git_state_validator.get_staged_files", return_value=["file.py"]),
            patch("auto_pr.git_state_validator.get_staged_status", return_value="M file.py"),
            patch("auto_pr.git_state_validator.run_git_command"),
            patch("auto_pr.git_state_validator.preprocess_diff", return_value="processed"),
        ):
    ...
    @patch("auto_pr.git_state_validator.console.print")
    @patch("click.prompt")
