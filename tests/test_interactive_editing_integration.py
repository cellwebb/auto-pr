...
class TestInplaceEditingIntegration:
    ...
    def test_main_workflow_with_edit_option(self, tmp_path):
        ...
        try:
            ...
            with (
                ...
                mock.patch("auto_pr.main.generate_commit_message", return_value="test: initial commit message"),
                mock.patch("prompt_toolkit.Application.run", side_effect=mock_app_run),
                mock.patch.dict("os.environ", {"AUTO_PR_MODEL": "anthropic:claude-haiku-4-5"}),
            ):
                try:
                    main(
    ...
    def test_main_workflow_edit_then_regenerate(self, tmp_path):
        ...
        try:
            ...
            with (
                mock.patch("click.prompt", side_effect=mock_click_prompt),
                mock.patch("auto_pr.main.generate_commit_message", side_effect=mock_generate),
                mock.patch("prompt_toolkit.Application.run", side_effect=mock_app_run),
                mock.patch.dict("os.environ", {"AUTO_PR_MODEL": "anthropic:claude-haiku-4-5"}),
            ):
                try:
    ...
    def test_main_workflow_edit_cancelled(self, tmp_path):
        ...
        try:
            ...
            with (
                mock.patch("click.prompt", side_effect=mock_click_prompt),
                mock.patch("auto_pr.main.generate_commit_message", return_value="test: original message"),
