...
from auto_pr.oauth.qwen_oauth import (
    QWEN_CLIENT_ID,
...
class TestQwenDeviceFlow:
    ...
    @mock.patch("auto_pr.oauth.qwen_oauth.httpx.post")
    ...
    @mock.patch("auto_pr.oauth.qwen_oauth.time.sleep")
    @mock.patch("auto_pr.oauth.qwen_oauth.httpx.post")
    ...
    @mock.patch("auto_pr.oauth.qwen_oauth.time.sleep")
    @mock.patch("auto_pr.oauth.qwen_oauth.time.time")
    @mock.patch("auto_pr.oauth.qwen_oauth.httpx.post")
...
class TestQwenOAuthProvider:
    ...
    def test_init_default_token_store(self):
        ...
        with mock.patch("auto_pr.oauth.qwen_oauth.TokenStore") as mock_store:
            QwenOAuthProvider()
    ...
    @mock.patch("auto_pr.oauth.qwen_oauth.webbrowser.open")
