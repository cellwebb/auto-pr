...
import auto_pr.ai_utils as ai_utils  # noqa: E402
from auto_pr.errors import AIError  # noqa: E402
...
class TestCountTokens:
    ...
    def test_count_tokens(self):
        ...
        with patch("auto_pr.ai_utils.get_encoding") as mock_get_encoding:
    ...
    @patch("auto_pr.ai_utils.tiktoken")
    def test_local_providers_use_default_encoding(self, mock_tiktoken):
        ...
        mock_tiktoken.get_encoding.assert_called_with(auto_pr.constants.Utility.DEFAULT_ENCODING)
    ...
    def test_no_tiktoken_mode_skips_tiktoken(self, monkeypatch):
        ...
        monkeypatch.delenv("AUTO_PR_NO_TIKTOKEN", raising=False)
        ai_utils._should_skip_tiktoken_counting.cache_clear()
