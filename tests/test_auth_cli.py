...
from auto_pr.auth_cli import auth, claude_code, qwen
...
class TestAuthCli:
    ...
    @mock.patch("auto_pr.auth_cli.TokenStore")
...
class TestClaudeCodeAuthCli:
    ...
    @mock.patch("auto_pr.auth_cli.authenticate_and_save")
    @mock.patch("auto_pr.auth_cli.TokenStore")
    @mock.patch("auto_pr.auth_cli.setup_logging")
    ...
    @mock.patch("auto_pr.auth_cli.remove_token")
    @mock.patch("auto_pr.auth_cli.TokenStore")
...
class TestQwenAuthCli:
    ...
    @mock.patch("auto_pr.auth_cli.QwenOAuthProvider")
