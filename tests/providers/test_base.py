...
from auto_pr.providers.base import (
    AnthropicCompatibleProvider,
    OpenAICompatibleProvider,
    ProviderConfig,
)
from auto_pr.providers.error_handler import (
...
class TestOpenAICompatibleProvider:
    ...
    def test_ssl_verification_enabled(self):
        ...
        with (
            patch("auto_pr.providers.base.httpx.post") as mock_post,
            patch.dict(os.environ, {"SIMPLE_API_KEY": "test-key"}),
            patch("auto_pr.providers.base.get_ssl_verify", return_value=True),
        ):
    ...
    def test_ssl_verification_can_be_disabled(self):
        ...
        with (
            patch("auto_pr.providers.base.httpx.post") as mock_post,
            patch.dict(os.environ, {"SIMPLE_API_KEY": "test-key"}),
            patch("auto_pr.providers.base.get_ssl_verify", return_value=False),
        ):
            mock_post.return_value.json.return_value = {"choices": [{"message": {"content": "test content"}}]}
            mock_post.return_value.raise_for_status = MagicMock()
