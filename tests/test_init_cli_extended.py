...
from auto_pr.init_cli import init


def test_init_cli_creates_new_auto_pr_env_file(clean_env_state):
    """Test that init creates .auto-pr.env if it doesn't exist (init workflow)."""
    runner = CliRunner()
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        with (
            ...
            with (
                ...
                assert "AUTO_PR_MODEL='anthropic:claude-sonnet-4-5'" in env_text
